    ...
    resources: {
      ...
      ja: {
        translation: {
          ...
          alerts: {
            geolocation:
              'このアプリケーションを使用するには、ブラウザのジオロケーションを有効にしてください。',
            food_cart_open:
              '準備中',
            map_location: '地図上で自分の位置を確認してください。',
            start_time: '開始時間を選択してください。',
            end_time: '終了時間を選択してください。',
            early_end: '終了時間は開始時間よりも遅くなければなりません。',
            location: '場所を説明してください。',
            geolocation_support:
              'このブラウザではジオロケーションをサポートされていません。',
            authorization: 'アクセスが拒否されました。',
          },
        },
      },
    },
